...
import { PlayIcon, StopIcon } from "@ui/components/icons";
...
// Play / stop for the live schedule; enablement comes from run.flags and each
// action commits the run transform at the cursor minute. With no live schedule
// the controls stay visible but disabled.
export function RunControls({ scheduleId, flags, atMinute }: Props): JSX.Element {
  const act = (action: "play" | "stop") => () => {
